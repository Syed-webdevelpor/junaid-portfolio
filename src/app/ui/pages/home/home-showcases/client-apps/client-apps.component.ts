...
export class ClientAppsComponent implements OnInit {
  ...
  _mClientApps = [
    ...
    {
     "id": "5131",
     "name": "Peak Aaepa: For Record",
     "image": "assets/img/clients/peak.png",
     "link": "https://peak.aaepa.com/",
     "tab": "Web App",
     "color": "#ba9c56"
   },
   ...
   {
     "id": "5132",
     "name": "Afcat: Ecommerce Store",
     "image": "assets/img/clients/afcat.png",
     "link": "https://marketplace.afcatusa.com/",
     "tab": "Web App"
   },
  ];
}
